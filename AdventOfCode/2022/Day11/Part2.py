class Monkey:
    ...
    def doTurn(self, monkeys, MULT):
        while (self.items):
            self.doItem(monkeys, MULT)
...
def doRound(monkeys, MULT):
    for monkey in monkeys:
        monkey.doTurn(monkeys, MULT)

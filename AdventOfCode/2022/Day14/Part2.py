...
def fall1Sand(cave, x, y):
    """
    :return: True if room left, i.e. if cave is not full (= immediately stopped)
    """
    caveHeight = len(cave)
...
if __name__ == "__main__":
    ...
    extendHeight(cave, len(cave) + 1)
    extendWidth(cave, len(cave[0]) + 200)  # Just to have enough room on the right

...
if __name__ == "__main__":
    ...
    with open("data1.txt", "r") as input:
        ...
        s = sorted(allData, key=cmp_to_key(compare))

        for d in s:
            print(d)

        i1 = s.index(marker1) + 1
        i2 = s.index(marker2) + 1

        print("Marker1 at %s and marker2 at %i: product=%i" % (i1, i2, i1 * i2))
